                ...
                <div className="col-lg-12 mt-3 wow fadeInUp" data-wow-delay="100">
                    <div className="container">
                        <div className="btn-group mb-2" role="group" aria-label="Basic checkbox toggle button group">
                            ...
                            <label className="btn btn-outline-primary" for="btnradio1">Amenidades</label>
                            ...
                            <label className="btn btn-outline-primary" for="btnradio2">Servicios</label>
                    ...
                    <div className="container">
                        ...
                        <div className="row d-flex justify-content-center ms-3">
                            {entrepreneurship.offers.map((offer, index) => {
                                ...
                                return (
                                    <div key={index} className="col-lg-3">
                                        <Image src="/images/home-v3/room.png" alt="" width={170} height={100} />
